...
void main() {
  ...
  testWidgets('DataTable2 control test (DataRow2, with row level events)', (WidgetTester tester) async {
    ...
    await tester.tap(find.text('Cupcake'));
    await tester.pump(const Duration(milliseconds: 300)); // if there's a double tap event you need to give some time to let input system decide there's no second tap following and onTap event is good to be fired
