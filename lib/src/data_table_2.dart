...
class DataColumn2 extends DataColumn {
  ...
  const DataColumn2({required super.label, super.tooltip, super.numeric = false, super.onSort, super.headingRowAlignment, this.size = ColumnSize.M, this.fixedWidth});
...
class DataRow2 extends DataRow {
  ...
  DataRow2.byIndex({super.index, super.selected = false, super.onSelectChanged, super.color, this.decoration, required super.cells, this.specificRowHeight, this.onTap, this.onDoubleTap, super.onLongPress, this.onSecondaryTap, this.onSecondaryTapDown}) : super.byIndex();
...
class DataTable2 extends DataTable {
  ...
  Widget _buildCheckbox({required BuildContext context, required bool? checked, required VoidCallback? onRowTap, required ValueChanged<bool?>? onCheckboxChanged, required WidgetStateProperty<Color?>? overlayColor, required CheckboxThemeData? checkboxTheme, required bool tristate, required double? rowHeight}) {
  ...
  Widget _buildHeadingCell({required BuildContext context, required EdgeInsetsGeometry padding, required Widget label, required String? tooltip, required bool numeric, required VoidCallback? onSort, required bool sorted, required bool ascending, required double effectiveHeadingRowHeight, required WidgetStateProperty<Color?>? overlayColor, required MainAxisAlignment headingRowAlignment}) {
  ...
  Widget _buildDataCell({required BuildContext context, required EdgeInsetsGeometry padding, required double? specificRowHeight, required Widget label, required bool numeric, required bool placeholder, required bool showEditIcon, required GestureTapCallback? onTap, required GestureTapCallback? onDoubleTap, required GestureLongPressCallback? onLongPress, required GestureTapDownCallback? onTapDown, required GestureTapCancelCallback? onTapCancel, required GestureTapCallback? onRowTap, required GestureTapCallback? onRowDoubleTap, required GestureLongPressCallback? onRowLongPress, required GestureTapCallback? onRowSecondaryTap, required GestureTapDownCallback? onRowSecondaryTapDown, required VoidCallback? onSelectChanged, required WidgetStateProperty<Color?>? overlayColor}) {
    final ThemeData themeData = Theme.of(context);
    final DataTableThemeData dataTableTheme = DataTableTheme.of(context);
    ...
    label = Container(
      ...
      child: DefaultTextStyle(
        style: effectiveDataTextStyle.copyWith(
          color: placeholder ? effectiveDataTextStyle.color! : null,
        ),
  ...
  Widget build(BuildContext context) {
    ...
    List<TableRow>? coreRows = rows.isEmpty || actualFixedColumns >= columns.length + (showCheckboxColumn ? 1 : 0) ? null : _buildTableRows(anyRowSelectable, effectiveDataRowColor, context, theme, tableColumnWidths.length - actualFixedColumns, defaultRowColor, actualFixedRows == 0 ? _buildHeadingRow(context, theme, effectiveHeadingRowColor, tableColumnWidths.length - actualFixedColumns) : null, actualFixedRows > 0 ? actualFixedRows - 1 : 0);

    List<TableRow>? fixedColumnsRows = rows.isEmpty
        ? null
        : actualFixedColumns > 0
            ? (actualFixedRows < 1 ? [_buildHeadingRow(context, theme, fixedColumnsColor != null ? WidgetStatePropertyAll(fixedColumnsColor) : effectiveHeadingRowColor, actualFixedColumns), ..._buildTableRows(anyRowSelectable, fixedColumnsColor != null ? WidgetStatePropertyAll(fixedColumnsColor) : effectiveDataRowColor, context, theme, actualFixedColumns, defaultRowColor, null, 0, 0, true)] : _buildTableRows(anyRowSelectable, fixedColumnsColor != null ? WidgetStatePropertyAll(fixedColumnsColor) : effectiveDataRowColor, context, theme, actualFixedColumns, defaultRowColor, null, actualFixedRows - 1, 0, true))
            : null;

    List<TableRow>? fixedRows = actualFixedRows > 0 ? (actualFixedRows == 1 ? [_buildHeadingRow(context, theme, headingRowColor ?? effectiveHeadingRowColor, tableColumnWidths.length - actualFixedColumns)] : [_buildHeadingRow(context, theme, headingRowColor ?? effectiveHeadingRowColor, tableColumnWidths.length - actualFixedColumns), ..._buildTableRows(anyRowSelectable, headingRowColor ?? effectiveDataRowColor, context, theme, tableColumnWidths.length - actualFixedColumns, defaultRowColor, null, 0, actualFixedRows - 1, true)]) : null;

    List<TableRow>? fixedCornerRows = actualFixedColumns > 0 && actualFixedRows > 0 ? (actualFixedRows == 1 ? [_buildHeadingRow(context, theme, fixedCornerColor != null ? WidgetStatePropertyAll(fixedCornerColor) : effectiveHeadingRowColor, actualFixedColumns)] : [_buildHeadingRow(context, theme, fixedCornerColor != null ? WidgetStatePropertyAll(fixedCornerColor) : effectiveHeadingRowColor, actualFixedColumns), ..._buildTableRows(anyRowSelectable, fixedCornerColor != null ? WidgetStatePropertyAll(fixedCornerColor) : effectiveDataRowColor, context, theme, actualFixedColumns, defaultRowColor, null, 0, actualFixedRows - 1, true)]) : null;

    double checkBoxWidth = _addCheckBoxes(displayCheckboxColumn, effectiveHorizontalMargin, tableColumnWidths, headingRow, effectiveHeadingRowHeight, context, someChecked, allChecked, coreRows, fixedRows, fixedCornerRows, fixedColumnsRows, rows, actualFixedRows, effectiveDataRowColor);
          ...
          builder: (context, sc11, sc12, sc21, sc22) {
            ...
            for (int dataColumnIndex = 0; dataColumnIndex < columns.length; dataColumnIndex++) {
              ...
              for (final DataRow row in rows) {
                ...
                var c = _buildDataCell(context: context, padding: padding, specificRowHeight: row is DataRow2 ? row.specificRowHeight : null, label: cell.child, numeric: column.numeric, placeholder: cell.placeholder, showEditIcon: cell.showEditIcon, onTap: cell.onTap, onDoubleTap: cell.onDoubleTap, onLongPress: cell.onLongPress, onTapDown: cell.onTapDown, onTapCancel: cell.onTapCancel, onRowTap: row is DataRow2 ? row.onTap : null, onRowDoubleTap: row is DataRow2 ? row.onDoubleTap : null, onRowLongPress: row.onLongPress, onRowSecondaryTap: row is DataRow2 ? row.onSecondaryTap : null, onRowSecondaryTapDown: row is DataRow2 ? row.onSecondaryTapDown : null, onSelectChanged: row.onSelectChanged != null ? () => row.onSelectChanged!(!row.selected) : null, overlayColor: row.color ?? effectiveDataRowColor);
            ...
            if (rows.isNotEmpty) {
              ...
              fixedRowsAndCoreCol = Scrollbar(
                  ...
                  child: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Flexible(fit: FlexFit.tight, child: Scrollbar(thumbVisibility: isVerticalScrollBarVisible ?? (isiOS ? scrollBarTheme.thumbVisibility?.resolve({WidgetState.hovered}) : null), thickness: (isiOS ? scrollBarTheme.thickness?.resolve({WidgetState.hovered}) : null), controller: coreVerticalController, child: SingleChildScrollView(controller: coreVerticalController, scrollDirection: Axis.vertical, child: SingleChildScrollView(controller: coreHorizontalController, scrollDirection: Axis.horizontal, child: addBottomMargin(coreTable)))))
                  ]));

              fixedColumnAndCornerCol = fixedTopLeftCornerTable == null && fixedColumnsTable == null ? null : Column(mainAxisSize: MainAxisSize.min, children: [if (fixedTopLeftCornerTable != null) fixedTopLeftCornerTable, if (fixedColumnsTable != null) Flexible(fit: FlexFit.loose, child: ScrollConfiguration(behavior: ScrollConfiguration.of(context).copyWith(scrollbars: false), child: SingleChildScrollView(controller: leftColumnVerticalContoller, scrollDirection: Axis.vertical, child: addBottomMargin(fixedColumnsTable))))]);
            }
  ...
  double _addCheckBoxes(bool displayCheckboxColumn, double effectiveHorizontalMargin, List<TableColumnWidth> tableColumns, TableRow headingRow, double headingHeight, BuildContext context, bool someChecked, bool allChecked, List<TableRow>? coreRows, List<TableRow>? fixedRows, List<TableRow>? fixedCornerRows, List<TableRow>? fixedColumnRows, List<DataRow> rows, int actualFixedRows, WidgetStateProperty<Color?>? effectiveDataRowColor) {
    ...
    if (displayCheckboxColumn) {
      ...
      headingRow.children[0] = showHeadingCheckBox
          ? _buildCheckbox(context: context, checked: someChecked ? null : allChecked, onRowTap: null, onCheckboxChanged: (bool? checked) => _handleSelectAll(checked, someChecked), overlayColor: null, checkboxTheme: headingCheckboxTheme, tristate: true, rowHeight: headingHeight)
          : SizedBox(
  ...
  List<TableRow> _buildTableRows(bool anyRowSelectable, WidgetStateProperty<Color?>? effectiveDataRowColor, BuildContext context, ThemeData theme, int numberOfCols, WidgetStateProperty<Color?> defaultRowColor, TableRow? headingRow, [int skipRows = 0, int takeRows = 0, bool forceEffectiveDataRowColor = false]) {
